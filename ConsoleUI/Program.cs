...
namespace ConsoleUI
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(brand1.BrandName + Messages.CarAdded);
            brandManager.Delete(brand1);
            Console.WriteLine(brand1.BrandName + Messages.Deleted);
            brandManager.Update(new Brand { BrandName = "TESLA", BrandId = 4 });
            Console.WriteLine(brand1.BrandName + Messages.Updated);
